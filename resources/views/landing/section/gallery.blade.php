<section id="gallery" class="portfolio section light-background">
            ...
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                    <div class="portfolio-content h-100">
                        <a href="{{ asset('assets/landing/img/portfolio/app-1.jpg') }}" data-gallery="portfolio-gallery-app"
                            class="glightbox"><img src="{{ asset('assets/landing/img/portfolio/app-1.jpg') }}" class="img-fluid"
                                alt=""></a>
